<?php
    ...
    function validate(): array{
        ...
        // ファイル名から拡張子をチェックする
        // in_array関数は、配列の中に指定した値が存在するかチェックする関数です。
...
<body>
    ...
    (元のファイル名：<?=escape($_FILES['image1']['tmp_name'])?>)<br>
</body>
